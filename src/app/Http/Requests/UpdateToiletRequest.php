 ...
 * @property bool|null $is_qualified Whether the entry has been verified
...
class UpdateToiletRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            if ($this->has('is_unisex') && $this->has('is_gender_separated') && $this->boolean('is_unisex') && $this->boolean('is_gender_separated')) {
