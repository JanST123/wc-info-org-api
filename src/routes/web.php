...
// Protected Public API routes (requires valid API key)
...
// Utility routes (exempt from API key)
...
Route::middleware('admin.auth')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('api-keys', [AdminApiKeyController::class, 'index'])->name('api_keys.index');
    Route::post('api-keys', [AdminApiKeyController::class, 'store'])->name('api_keys.store');
    Route::post('api-keys/unblock', [AdminApiKeyController::class, 'unblock'])->name('api_keys.unblock');
    Route::post('api-keys/{id}', [AdminApiKeyController::class, 'update'])->name('api_keys.update');
    Route::post('api-keys/{id}/toggle', [AdminApiKeyController::class, 'toggle'])->name('api_keys.toggle');
    Route::post('api-keys/{id}/regenerate', [AdminApiKeyController::class, 'regenerate'])->name('api_keys.regenerate');
    ...
    Route::post('toilets/{id}/coordinates', [AdminToiletController::class, 'updateCoordinates'])->name('toilets.coordinates');
    ...
    Route::post('toilets/{id}/public-accessible', [AdminToiletController::class, 'updatePublicAccessible'])->name('toilets.public-accessible');
